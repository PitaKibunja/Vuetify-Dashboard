<template>
  <v-app id="inspire">
    ...
    <v-container>
      <v-app-bar color="rgba(0,0,0,0)" flat>
        <v-text-field label="Search..." class="pt-5" filled prepend-inner-icon="mdi-magnify"
      ...
      <v-select class="mt-7" :items=items v-model="select" item-text="state" color="black" solo
      flat style="max-width:7%;" item-color="grey darken-2"> </v-select>
      <span text color='#878A94'>AAF IdeaPro</span>
      ...
      <v-row>
        <v-col cols="12" sm="8">
            ...
            <v-row>
              <v-col cols="12" sm="8">
                <v-list-item three-line>
                  <v-list-item-content>
                  <v-list-item-title class="text-h4 mb-1">Hey AAE IdeaPro</v-list-item-title>
                  <v-list-item-subtitle>
                    Welcome back AAE IdeaPro. we are glad here. <br> Inspire 
                    the best work in people. enabling them to achieve
                  </v-list-item-subtitle>
                  <v-list-item-subtitle>thier goals</v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
                <v-card-actions>
                  <v-btn class="px-3" color="black" dark>View Details</v-btn>
                </v-card-actions>
              </v-col>
              <v-col cols="12" sm="4">
                  <v-img src="1.png" clas="mt-n16"></v-img>
              </v-col>
            </v-row>
          </v-card>
          ...
          <v-row class="mt-n5">
            <v-col cols="12" sm="4">
              <v-card class="rounded xl ml-4" color="grey lighten-3">
                <v-card-title>
                  <span class="text-h6 font-weight-light">Prototyping</span>
                </v-card-title>
                <v-card-text>
                  A prototype is an early <br> sample, model realease of a product but to text ...
                </v-card-text>
                <v-card-actions class="mt-n7">
                  <v-list-item>
                    <div class="" color="grey darken-3">
                      ...
                      <v-avatar class="ml-n3" size="30">
                        <img src="https://cdn.vuetifyjs.com/images/lists/3.jpg" alt="">
                      </v-avatar>
                      <v-avatar class="ml-n3" size="30">
                        <img src="https://cdn.vuetifyjs.com/images/lists/4.jpg" alt="">
                      </v-avatar>
  ...
  >
    ...
    <v-card-text class="">
      In essence, typography is the artof arranging letters and text in away that.. 
    </v-card-text>
  ...
  >
    <v-card-title>
      <span class="text-h6 font-weight-light">Color Palatte</span>
    </v-card-title>
        ...
        <v-card class="rounded-xl pa-4" color="grey lighten-3" flat>
          <v-app-bar color="rgba(0,0,0,0)" tile>
            ...
            <strong class="subtitle black--text ml-2">
              Articles Posted <span class="caption"><br>00</span>
            </strong>
            <v-spacer></v-spacer>
            <v-icon class="ml-2">fas fa-chevron-circle-right</v-icon>
          </v-app-bar>
          <v-app-bar color="rgba(0,0,0,0)" tile>
          ...
          <div class="px-7">
            <vueper-slides
             ...
             :breakpoints="{800:{visibleSlide:2,slideMultiple:2}}"
             >
             <template #arrow-left>
             ...
             <vueper-slide v-for="(slide,i) in slides" :key="i" :image="slide.src"></vueper-slide>
             </vueper-slides>
          </div>
          <v-card class="rounded-xl mx-4 pa-10" flat>
            <div class="text-center">
              <span>Buy <strong> Pro Account</strong>to Explore <br> Premium Features</span>
              <v-btn class="ml-5" dark color="black">Purchase Now</v-btn>
            </div>
          </v-card>
        </v-card>
      </v-col>
  ...
  export default {
    ...
    data:()=>({
      ...
      slides:[
        ...
        {src:require('../../public/02.jpg')},
        {src:require('../../public/03.jpg')},
        {src:require('../../public/04.jpg')},
        {src:require('../../public/05.jpg')},
        {src:require('../../public/06.jpg')},
        {src:require('../../public/07.png')},
        {src:require('../../public/08.png')},
        {src:require('../../public/09.jpg')},
        {src:require('../../public/10.jpg')},
        {src:require('../../public/11.jpg')},
        {src:require('../../public/12.jpg')},
      ]
